...
\textsc{\Large [LSINF~1225]}\\[0.1cm]
\textsc{\Large Conception Orientée Objet }\\[0.1cm]
\textsc{\Large et Gestion de Données}\\[0.9cm]


\textsc{\Large Année 2014--2015}\\[0.5cm]

% Title
\HRule \\[0.5cm]
\textsc{\LARGE  Travail 1}\\[0.2cm]
{ \huge \bfseries La Modélisation de Données \\[0.4cm] }
...
\begin{tabu} to 0.7\linewidth {Xll}
    \emph{Auteurs:}\\
    \quad Mathieu \textsc{Delandmeter} & 6591\,--\,13\,--\,00\\
    \quad Nathan \textsc{Gillain} & 6591\,--\,13\,--\,00\\
    \quad Maxime \textsc{Hanot} & 6591\,--\,13\,--\,00\\
    \quad Alexandre \textsc{Jadin} & 6591\,--\,13\,--\,00\\
    \quad Thomas \textsc{Marissal} & 6591\,--\,13\,--\,00\\
    \quad Edouard \textsc{Vangangel} & 6591\,--\,13\,--\,00\\[.5ex]   
    \emph{Professeur:} \\
    \quad Kim \textsc{Mens}\\[.5ex]
    \emph{Tuteur:}\\
    \quad Benoit \textsc{Xxx}\\
\end{tabu}
}
