...
do
	...
	echo "INSERT INTO [Boisson] ([Nom], [PrixAchat], [PrixVente], [Description], [Photo], [Type], [Stock], [Seuil], [Max]) VALUES (\"$nom\", $prixAchat, $prixVente, $description, $photo, \"$types\", $stock, $seuil, $max);" >> commandes.sql
done < boissons.cvs
