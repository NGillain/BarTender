Liste des fichiers :
-Rapport2.pdf 		: le rapport décrivant les choix de conceptions et une brève introduction
-User_stories.pdf 	: contient l'ensemble des user-stories groupé par catégories
-DiagramUML.png		: le diagramme de classes UML
