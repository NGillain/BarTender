...
Bien que celles-ci n'aie pas été mises à jour et donc que ce sont des brouillons, elles nous on permis de bien comprendre comment nous allions organiser notre code. Nous les avons dès lors utilisées afin de créer notre diagramme de classe UML.
