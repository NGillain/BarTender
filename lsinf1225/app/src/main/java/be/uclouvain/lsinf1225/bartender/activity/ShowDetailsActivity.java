...
public class ShowDetailsActivity extends Activity implements RatingBar.OnRatingBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name.setText(currentBoisson.getName());
        ...
        rating.setRating(currentBoisson.getRating());
    ...
    public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
        if (fromUser) {
            if (!currentBoisson.setRating(rating)) {
                ...
                ratingBar.setRating(currentBoisson.getRating());
            }
        }
    }
}
