...
public class ShowListActivity extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myListViewAdapter = new MyListViewAdapter(this, boissons);
    ...
    private void loadBoisson() {
        ...
        if (searchQuery == null) {
            boissons = Boisson.getBoisson();
        } else {
            boissons = Boisson.searchBoisson(searchQuery);
        }
    ...
    public void onResume() {
        ...
        myListViewAdapter.setBoissons(boissons);
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        // récupérer celui-ci.
        intent.putExtra("ci_id", boissons.get(position).getId());
        ...
        switch (view.getId()) {
            ...
            case R.id.show_list_rating_title:
                if (Boisson.order_by.equals(Boisson.DB_COL_RATING)) {
                    ...
                    Boisson.order_by = Boisson.DB_COL_RATING;
                    Boisson.order = "DESC";
                }
                break;
        }
    ...
    private void updateDrawableOrder() {
        ...
        TextView orderTitle;
        boolean orderByRating = Boisson.order_by.equals(Boisson.DB_COL_RATING);
        if (orderByRating) {
        ...
        boolean orderDesc = Boisson.order.equals("DESC");
